...
<!DOCTYPE html>
<HTML>
<title>Historial velocidad del viento — Estación #1</title>
...
<a href="velocidad_export.html" class="button">Exportar datos CSV</a>
</div>
                ...
                data: (function() {
                   var data = [];
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $rawdata[$i]["FECHA"];?>,<?php echo $rawdata[$i]["VEL_VIENTO"];?>]);
                    <?php } ?>
                return data;
                })()
        }]
