<?php
 ...
 function conectarBD(){ 
    ...
    //Sentencia SQL
$sql = "SELECT FECHA, HUMEDAD from cosmic;";
...
<a href="hum_export.html" class="button">Exportar datos CSV</a>
</div>
                ...
                data: (function() {
                   var data = [];
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $rawdata[$i]["FECHA"];?>,<?php echo $rawdata[$i]["HUMEDAD"];?>]);
                    <?php } ?>
                return data;
                })()
        }]
