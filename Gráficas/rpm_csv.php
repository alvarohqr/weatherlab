...
<!DOCTYPE html>
<HTML>
<title>Historial partículas en suspensión — Estación #1</title>
...
<a href="pm_export.html" class="button">Exportar datos CSV</a>
</div>
                ...
                data: (function() {
                   var data = [];
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $rawdata[$i]["FECHA"];?>,<?php echo $rawdata[$i]["PM2.5"];?>]);
                    <?php } ?>
                return data;
                })()
            },{
